...
export default function StakeCard() {
  ...
  <div className="w-full max-w-md bg-color-ash p-8 rounded-bigview shadow-2xl border border-white/5 relative overflow-hidden font-inter">
    ...
    <div className="mb-8 text-center relative z-10">
      ...
      <h2 className="text-2xl font-black text-white mb-1 tracking-tighter">Bigview Stake</h2>
    ...
    <div className="space-y-6 relative z-10">
      <div className="space-y-3">
        <div className="flex justify-between items-end px-1">
          <label className="text-[10px] font-black text-color-white/30">Amount</label>
          <span className="text-[9px] font-black text-gold-buttons bg-color-ash/10 px-2.5 py-1 rounded-bigview  border border-gold-buttons/20">
            Bal: {balance} ETH
          </span>
        </div>
      ...
      <button 
        ...
        className="w-full py-5 bg-color-ash text-text-color rounded-bigview font-black text-lg shadow-xl shadow-gold-buttons/10 transition-all active:scale-95 flex items-center justify-center gap-3 tracking-tight hover:opacity-90 disabled:opacity-50 disabled:bg-white/5 disabled:text-white/20"
      >
      ...
      {txHash && (
        <p className="text-[8px] text-emerald-500 font-black text-center animate-pulse">
