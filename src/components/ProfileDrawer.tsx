...
notify('Profile Updated!');
  ...
  <div className="fixed inset-0 z-[300] bg-violet-background flex flex-col animate-in slide-in-from-right duration-500 font-inter overflow-hidden">
    ...
    {message && (
      <div className="fixed top-24 left-1/2 -translate-x-1/2 z-[400] animate-in fade-in slide-in-from-top-4">
        <div className="bg-gold-buttons text-text-color text-[10px] font-black uppercase tracking-widest px-6 py-2 rounded-bigview shadow-2xl italic border border-white/10">
          {message}
        </div>
      </div>
    )}
    ...
    <div className="absolute top-0 right-0 w-64 h-64 bg-violet-glow/10 rounded-full blur-[100px] -mr-32 -mt-32" />
    <div className="absolute bottom-0 left-0 w-64 h-64 bg-gold-buttons/5 rounded-full blur-[100px] -ml-32 -mb-32" />
    ...
    <div className="relative z-10 p-6 flex items-center justify-between border-b border-white/5 bg-black/20 backdrop-blur-xl">
      <div className="flex items-center gap-3">
        <div className="p-2 bg-white/5 rounded-bigview">
      ...
      <button 
        onClick={onClose} 
        className="p-3 bg-white/5 hover:bg-white/10 rounded-bigview text-white transition-all active:scale-90"
      >
        <X size={24} />
      </button>
    </div>
   ...
   />
        ...
        <button 
          ...
          className="absolute -bottom-2 -right-2 p-3 rounded-bigview bg-gold-buttons text-text-color shadow-xl border-4 border-violet-background active:scale-90 transition-all"
        >
          <Camera size={18} />
        </button>
    ...
    <div className="relative z-10 flex-1 overflow-y-auto px-6 space-y-4 pb-10">
      ...
      <div className="p-5 rounded-bigview border border-white/5 bg-white/[0.03] backdrop-blur-md">
        <p className="text-[9px] font-black text-white/40 uppercase tracking-[0.2em] mb-3">Wallet Controller</p>
        <div className="flex items-center justify-between">
          ...
          <button onClick={copyAddress} className="p-2 text-white/40 hover:text-white transition-colors">
            <Copy size={16} />
          </button>
        </div>
      </div>
      ...
      <div className="p-5 rounded-bigview border border-white/5 bg-white/[0.03] backdrop-blur-md">
        <p className="text-[9px] font-black text-white/40 uppercase tracking-[0.2em] mb-3">Membership Tier</p>
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="p-2 bg-gold-buttons/10 rounded-bigview">
              <ShieldCheck size={16} className="text-gold-buttons" />
            </div>
            <span className="text-xs font-black text-gold-buttons uppercase italic">Tier 1 • Genesis</span>
          </div>
          <button className="text-[10px] font-black text-white/60 hover:text-gold-buttons uppercase tracking-widest flex items-center gap-1 transition-colors">
      ...
      <div className="pt-6 space-y-3">
         <button className="w-full flex items-center justify-between p-5 rounded-bigview bg-white/[0.03] border border-white/5 hover:bg-white/[0.06] transition-all group">
