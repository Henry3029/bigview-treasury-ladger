        ...
        <section className="grid grid-cols-3 gap-4">
           {[
             ...
             <div key={item.label} className="flex flex-col items-center">
                <button className="w-16 h-16 bg-white/5 border border-white/5 rounded-bigview flex items-center justify-center mb-2 shadow-xl active:scale-90 transition-all hover:bg-white/10 group">
